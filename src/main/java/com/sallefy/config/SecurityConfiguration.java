...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .headers()
            .contentSecurityPolicy("default-src 'self' https://res.cloudinary.com http://res.cloudinary.com; frame-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://storage.googleapis.com; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; img-src * 'self' data:; font-src 'self' https://fonts.gstatic.com data:")
        .and()
