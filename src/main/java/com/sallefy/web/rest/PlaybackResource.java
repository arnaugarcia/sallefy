...
public class PlaybackResource {
    ...
    public ResponseEntity<PlaybackDTO> createPlayback(@RequestBody PlaybackDTO playbackDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PlaybackDTO> updatePlayback(@RequestBody PlaybackDTO playbackDTO) throws URISyntaxException {
