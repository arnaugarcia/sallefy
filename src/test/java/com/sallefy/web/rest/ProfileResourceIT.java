...
import com.sallefy.domain.Profile;
import com.sallefy.repository.ProfileRepository;
import com.sallefy.service.ProfileService;
import com.sallefy.service.dto.ProfileDTO;
import com.sallefy.service.mapper.ProfileMapper;
...
public class ProfileResourceIT {
    ...
    private static final Boolean DEFAULT_ARTIST = false;
    private static final Boolean UPDATED_ARTIST = true;
    ...
    public void createProfile() throws Exception {
        ...
        assertThat(testProfile.isArtist()).isEqualTo(DEFAULT_ARTIST);
        assertThat(testProfile.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testProfile.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testProfile.getBiography()).isEqualTo(DEFAULT_BIOGRAPHY);
    }
    ...
    public void getAllProfiles() throws Exception {
        ...
        restProfileMockMvc.perform(get("/api/profiles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].artist").value(hasItem(DEFAULT_ARTIST.booleanValue())))
    ...
    public void getProfile() throws Exception {
        ...
        restProfileMockMvc.perform(get("/api/profiles/{id}", profile.getId()))
            ...
            .andExpect(jsonPath("$.artist").value(DEFAULT_ARTIST.booleanValue()))
    ...
    public void updateProfile() throws Exception {
        ...
        Profile testProfile = profileList.get(profileList.size() - 1);
        assertThat(testProfile.isArtist()).isEqualTo(UPDATED_ARTIST);
        assertThat(testProfile.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testProfile.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testProfile.getBiography()).isEqualTo(UPDATED_BIOGRAPHY);
    }
