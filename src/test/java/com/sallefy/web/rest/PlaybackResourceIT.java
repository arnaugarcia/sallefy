...
public class PlaybackResourceIT {
    ...
    private static final AgentType DEFAULT_AGENT = AgentType.MOBILE;
    private static final AgentType UPDATED_AGENT = AgentType.WEB;
    ...
    public static Playback createEntity(EntityManager em) {
        ...
        // Add required entity
        Track track;
        if (TestUtil.findAll(em, Track.class).isEmpty()) {
            track = TrackResourceIT.createEntity(em);
            em.persist(track);
            em.flush();
        } else {
            track = TestUtil.findAll(em, Track.class).get(0);
        }
    ...
    public static Playback createUpdatedEntity(EntityManager em) {
        ...
        Track track;
        if (TestUtil.findAll(em, Track.class).isEmpty()) {
            track = TrackResourceIT.createUpdatedEntity(em);
            em.persist(track);
            em.flush();
        } else {
            track = TestUtil.findAll(em, Track.class).get(0);
    ...
    public void createPlayback() throws Exception {
        ...
        assertThat(testPlayback.getAgent()).isEqualTo(DEFAULT_AGENT);
    ...
    public void updatePlayback() throws Exception {
        ...
        assertThat(testPlayback.getAgent()).isEqualTo(UPDATED_AGENT);
