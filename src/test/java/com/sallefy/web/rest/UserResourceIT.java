...
public class UserResourceIT {
    ...
    public void setup() {
        ...
        UserResource userResource = new UserResource(userService, userRepository, followService, playlistService, trackQueryService, userQueryService, mockUserSearchRepository);
    ...
    public void createUserWithExistingLogin() throws Exception {
        ...
        mockUserSearchRepository.save(new UserSimplifiedDTO(user));
        int databaseSizeBeforeCreate = userRepository.findAll().size();
    ...
    public void updateUserExistingEmail() throws Exception {
        ...
        mockUserSearchRepository.save(new UserSimplifiedDTO(anotherUser));
