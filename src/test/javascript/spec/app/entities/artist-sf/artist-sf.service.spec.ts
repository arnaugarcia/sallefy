...
describe('Service Tests', () => {
  describe('ArtistSf Service', () => {
    let injector: TestBed;
    let service: ArtistSfService;
    let httpMock: HttpTestingController;
    let elemDefault: IArtistSf;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ArtistSf', async () => {
      ...
      it('should update a ArtistSf', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            reference: 'BBBBBB',
      ...
      it('should return a list of ArtistSf', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            reference: 'BBBBBB',
      ...
      it('should delete a ArtistSf', async () => {
