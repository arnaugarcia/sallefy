...
describe('Service Tests', () => {
  describe('FollowUser Service', () => {
    ...
    let elemDefault: IFollowUser;
    let expectedResult: IFollowUser | IFollowUser[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(FollowUserService);
