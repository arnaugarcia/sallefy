...
describe('Service Tests', () => {
  describe('Playback Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(PlaybackService);
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Playback', () => {
        const returnedFromService = Object.assign(
          {
            ip: 'BBBBBB',
            latitude: 1,
